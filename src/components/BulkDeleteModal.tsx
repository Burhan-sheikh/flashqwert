// /home/project/src/components/BulkDeleteModal.tsx
...
interface BulkDeleteModalProps {
    ...
    isBulkDelete?: boolean; // new prop
}

const BulkDeleteModal: React.FC<BulkDeleteModalProps> = ({ isOpen, onClose, onConfirm, selectedCount, isBulkDelete }) => {
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">
                                {isBulkDelete ? `Delete ${selectedCount} QR Code(s)?` : `Delete QR Code?`}
                            </h3>
                            <p className="text-sm text-gray-600 mb-4">
                                Are you sure you want to delete {isBulkDelete ? "these QR codes" : "this QR code"}? This action cannot be undone.
                            </p>
                        </div>
